export const BackgroundFX = () => (
  <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
    ...
    <div className="floating pulse-glow absolute left-[12%] top-[30%] h-56 w-56 rounded-full border border-white/10 bg-white/5 opacity-40 blur-[60px]" />
    <div className="floating pulse-glow absolute bottom-[12%] right-[18%] h-48 w-48 rounded-full border border-white/10 bg-white/5 opacity-50 blur-[70px]" />
  </div>
);
