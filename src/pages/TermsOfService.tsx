...
const TermsOfService = () => {
  ...
  const titleKey = 'termsOfService.title';
  const lastUpdatedKey = 'termsOfService.lastUpdated';
  ...
  const currentLang = t('termsOfService.title') !== titleKey ? 'en' : 'id';

  return (
    <>
      <Helmet>
        <title>{title} - ekalliptus</title>
        <meta name="description" content={`Terms of Service for ekalliptus digital agency services. Learn about our service terms, user responsibilities, and legal agreements.`} />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href={getCanonicalUrl("/terms-of-service")} />
        <meta property="og:title" content={`${title} - ekalliptus`} />
        <meta property="og:description" content="Terms of Service for ekalliptus digital agency services" />
        ...
        <meta name="twitter:description" content="Terms of Service for ekalliptus digital agency services" />
      </Helmet>
        ...
        <div className="relative px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 md:p-12 space-y-8">
              {[
                'termsOfService.sections.agreement',
                'termsOfService.sections.description',
                'termsOfService.sections.userResponsibilities',
                'termsOfService.sections.paymentTerms',
                'termsOfService.sections.intellectualProperty',
                'termsOfService.sections.confidentiality',
                'termsOfService.sections.limitationOfLiability',
                'termsOfService.sections.disclaimerOfWarranties',
                'termsOfService.sections.serviceAvailability',
                'termsOfService.sections.termination',
                'termsOfService.sections.disputeResolution',
                'termsOfService.sections.indemnification',
                'termsOfService.sections.forceMajeure',
                'termsOfService.sections.changes',
                'termsOfService.sections.severability',
                'termsOfService.sections.entireAgreement',
                'termsOfService.sections.contact'
              ].map((sectionKey) => (
